                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        {medicine_name.length==0 && validation && <span className="text-danger">Medicine Name is required</span>}
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            ...
                                            <input value={medicine_catagory} onMouseDown={e=>valchange(true)} onChange={e=>medicinechange(e.target.value)} className="form-control"></input>
                                            {medicine_catagory.length==0 && validation &&  <span className="text-danger">Medicine catagory is required</span>}
